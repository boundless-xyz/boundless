...
check-format:
    ...
    cd examples/smart-contract-client && cargo sort --workspace --check
    cd examples/smart-contract-client && cargo fmt --all --check
...
format:
    ...
    cd examples/smart-contract-client && cargo sort --workspace
    cd examples/smart-contract-client && cargo fmt --all
