...
contract BoundlessMarketBasicTest is BoundlessMarketTest {
        ...
        returns (Client, Client, ProofRequest memory)
    {
        ...
        vm.expectEmit(true, true, true, true);
        emit IBoundlessMarket.FulfillmentFailed(
    ...
    function testPartialPriceFulfill() public {
        ...
        vm.expectEmit(true, true, true, true);
        emit IBoundlessMarket.FulfillmentFailed(error);
        vm.expectEmit(true, true, true, true);
    ...
    function testFulfillNeverLockedNotPriced() public {
        ...
        bytes[] memory fulfillmentError = boundlessMarket.fulfill(fills, assessorReceipt);
        assert(
            keccak256(fulfillmentError[0])
