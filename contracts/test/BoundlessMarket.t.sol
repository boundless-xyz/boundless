...
contract BoundlessMarketTest is Test {
    ...
    function setUp() public {
        ...
        mockCallback = new MockCallback(verifier, address(boundlessMarket), 10_000);
        mockHighGasCallback = new MockCallback(verifier, address(boundlessMarket), 250_000);
...
contract BoundlessMarketBasicTest is BoundlessMarketTest {
    ...
    function testLockRequestWithSignatureBadProverSignature() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                IBoundlessMarket.InsufficientBalance.selector, address(0x7a0Ad2100Bb2138708FE66f89F2346D26ADDFD84)
            )
        );
    ...
    function testFulfillLockedRequestWithCallbackAlreadyFulfilledByOtherProver() public {
        ...
        (fill, assessorSeal) = createFillAndSubmitRoot(request, APP_JOURNAL, address(testProver));
        boundlessMarket.fulfill(fill, assessorSeal, address(testProver));
