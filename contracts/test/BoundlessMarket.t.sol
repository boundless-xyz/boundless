...
contract BoundlessMarketBasicTest is BoundlessMarketTest {
        ...
        returns (Client, ProofRequest memory)
    {
        ...
        if (lockinMethod == LockRequestMethod.None) {
            ...
            vm.expectEmit(true, true, true, true);
            emit IBoundlessMarket.RequestFulfilled(request.id, testProverAddress, fills[0].requestDigest, address(0), 0);
    ...
    function testFulfillLargeJournal() external {
        ...
        vm.expectEmit(true, true, true, true);
        emit IBoundlessMarket.RequestFulfilled(request.id, testProverAddress, fill.requestDigest, address(0), 0);
        vm.expectEmit(true, true, true, false);
        emit IBoundlessMarket.ProofDelivered(request.id, testProverAddress, fill);
        boundlessMarket.fulfill(fills, assessorReceipt);
    ...
    function testFulfillWasLockedRequestByOtherProver() public returns (ProofRequest memory, Client, Client, Client) {
        ...
        vm.expectEmit(true, true, true, true);
        emit IBoundlessMarket.RequestFulfilled(request.id, otherProver.addr(), fill.requestDigest, address(0), 0);
        vm.expectEmit(true, true, true, false);
    ...
    function testFulfillWasLockedRequestByOriginalLocker() public returns (ProofRequest memory, Client) {
        ...
        vm.expectEmit(true, true, true, true);
        emit IBoundlessMarket.RequestFulfilled(request.id, lockerAddress, fill.requestDigest, address(0), 0);
        vm.expectEmit(true, true, true, false);
    ...
    function testFulfillLockedRequests() public {
        ...
        for (uint256 i = 0; i < fills.length; i++) {
            vm.expectEmit(true, true, true, true);
            emit IBoundlessMarket.RequestFulfilled(fills[i].id, testProverAddress, fills[i].requestDigest, address(0), 0);
            vm.expectEmit(true, true, true, false);
    ...
    function testSubmitRootAndPriceAndFulfillLockedRequest() external {
        ...
        vm.expectEmit(true, true, true, true);
        emit IBoundlessMarket.RequestFulfilled(requests[0].id, testProverAddress, fills[0].requestDigest, address(0), 0);
        vm.expectEmit(true, true, true, false);
    ...
    function testFulfillLockedRequestWithCallbackByOtherProver() public {
        ...
        vm.expectEmit(true, true, true, true);
        emit IBoundlessMarket.RequestFulfilled(request.id, otherProverAddress, fill.requestDigest, address(0), 0);
        vm.expectEmit(true, true, true, true);
        emit IBoundlessMarket.PaymentRequirementsFailed(abi.encodeWithSelector(
                IBoundlessMarket.RequestIsLocked.selector, request.id
            ));
    ...
    function testFulfillWasLockedRequestWithCallbackMultipleRequestsSameIndex() public {
        ...
        vm.expectEmit(true, true, true, true);
        emit IBoundlessMarket.RequestFulfilled(requestB.id, testProverAddress, fill.requestDigest, address(0), 0);
        vm.expectEmit(true, true, true, false);
