...
///         priced fulfillment paths (`priceAndFulfill`,
///         `priceAndFulfillAndWithdraw`, `submitRootAndPriceAndFulfill*`)
///         consume. Mirrors `FulfillmentBatch` in shape so the same-tx
///         price-then-fulfill API reads symmetrically:
///
