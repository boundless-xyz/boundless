...
pub struct LeaderboardResponse<T> {
    ...
    /// Timestamp of oldest data in response
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl<T> LeaderboardResponse<T> {
    ...
    pub fn with_last_updated(mut self, last_updated_at: Option<String>) -> Self {
...
pub struct AggregateStakingEntry {
    ...
    /// Total rewards earned from staking (actually received)
    pub total_rewards_earned: String,

    /// Total rewards earned (human-readable)
    pub total_rewards_earned_formatted: String,
...
pub struct StakingPositionData {
    ...
    /// Rewards generated by this position
    pub rewards_generated: String,
}
