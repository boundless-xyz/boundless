...
fn rewrite_solidity_interface_files() {
    ...
    println!("cargo:warning=Successfully generated boundless_market_generated.rs");
}
...
fn copy_interfaces_and_types() {
    ...
    println!("cargo:warning=Successfully copied contract interfaces and types");
}
...
fn generate_contracts_rust_file() {
    ...
    println!("cargo:warning=Successfully generated bytecode.rs");
}
