...
impl crate::request_builder::PriceProvider for MockPriceProvider {
    fn price_range(
        ...
        Box<
            dyn std::future::Future<
                    Output = anyhow::Result<crate::indexer_client::PriceRange>,
                > + '_,
        >,
    > {
    ...
    pub fn create_test_indexer_client() -> (MockServer, IndexerClient) {
        ...
        let indexer_client = IndexerClient::new(base_url)
            .expect("Failed to create IndexerClient from mock server URL");
