    ...
    Claim: Digestible + Debug + Clone + Serialize,
{
    ...
    /// produced by running the set builder, which verifies each receipt before adding
    ...
    Claim: Digestible + Debug + Clone + Serialize,
{
    ...
    pub fn verify_integrity_with_context(
        ...
        // Calculate the expected value of the journal generated by the set builder.
    ...
    /// parameters digest, which contains the set builder image ID. If non-empty, the
...
pub struct SetInclusionReceiptVerifierParameters {
    /// Image ID for the set builder guest.
    pub image_id: Digest,
}
...
alloy_sol_types::sol! {
    /// Journal output of set builder guest.
    #[sol(all_derives)]
    struct GuestOutput {
