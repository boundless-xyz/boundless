                ...
                cache_cloned
                    .try_get_with(cache_key_clone, async move {
                        ...
                        if request.client_address() == address!("0x3ee7d9175ec8bb9e16e8fd3abdef5a354b247528")
                            ...
                            let cycle_count = u64::try_from(request.offer.lockCollateral).unwrap_or(u64::MAX).saturating_mul(1_000_000).div_ceil(1500);
                        ...
                        if request.client_address() == address!("0x2546c553d857d20658ece248f7c7d0861a240681")
                            ...
                            || request.client_address() == address!("0xe198c6944cae382902a375b0b8673084270a7f8e")
                            || request.client_address() == address!("0xc197ebe12c7bcf1d9f3b415342bdbc795425335c")
                        {
