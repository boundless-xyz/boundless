...
-- Add lock/fulfill base fee to request_status
ALTER TABLE request_status ADD COLUMN IF NOT EXISTS lock_base_fee TEXT;
ALTER TABLE request_status ADD COLUMN IF NOT EXISTS fulfill_base_fee TEXT;
