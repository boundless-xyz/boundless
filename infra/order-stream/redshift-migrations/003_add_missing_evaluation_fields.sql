-- 003_add_missing_evaluation_fields.sql
-- Fix field name mismatch (estimated_total_proving_time_secs -> estimated_proving_time_secs)
-- and add missing columns to the request_evaluations view.
...
INSERT INTO telemetry._migrations (version, name) VALUES (3, '003_add_missing_evaluation_fields');
