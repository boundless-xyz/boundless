...
SKIP_PATHS = [
    ...
    # Shanghai variant: third-party-derived no-mcopy Bytes shim (kept under the variant and the
    # frozen legacy). Same MIT-derived provenance as the OpenZeppelin Bytes it replaces.
    str(Path.cwd()) + "/contracts/shanghai/compat/Bytes.sol",
    str(Path.cwd()) + "/contracts/shanghai/legacy/compat/Bytes.sol",
...
APACHE_PATHS = [
    ...
    str(Path.cwd()) + "/contracts/shanghai/legacy/IBoundlessMarketLegacy.sol",
