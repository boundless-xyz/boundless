...
SKIP_PATHS = [
    ...
    str(Path.cwd()) + "/contracts/shanghai/src/SetBuilderImageID.sol",
    str(Path.cwd()) + "/contracts/shanghai/src/libraries/AssessorImageID.sol",
    str(Path.cwd()) + "/contracts/shanghai/src/libraries/UtilImageID.sol",
    str(Path.cwd()) + "/contracts/shanghai/src/verifier/RiscZeroVerifierRouter.sol",
    str(Path.cwd()) + "/contracts/shanghai/src/blake3-groth16/Groth16Verifier.sol",
    str(Path.cwd()) + "/contracts/shanghai/src/compat/Bytes.sol",
...
APACHE_PATHS = [
    ...
    str(Path.cwd()) + "/contracts/shanghai/src/HitPoints.sol",
    str(Path.cwd()) + "/contracts/shanghai/src/IBoundlessMarket.sol",
    str(Path.cwd()) + "/contracts/shanghai/src/IHitPoints.sol",
    str(Path.cwd()) + "/contracts/shanghai/src/povw/IPovwAccounting.sol",
    str(Path.cwd()) + "/contracts/shanghai/src/povw/IPovwMint.sol",
    str(Path.cwd()) + "/contracts/shanghai/src/zkc/IStakingRewards.sol",
    str(Path.cwd()) + "/crates/bench",
    str(Path.cwd()) + "/crates/boundless-backend",
