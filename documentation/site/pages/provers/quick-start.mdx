...
For a quick set up of Boundless dependencies on Ubuntu 22.04/24.04, please run:
...
```bash [Terminal]
cargo install --locked --git https://github.com/boundless-xyz/boundless bento-client --branch release-0.14 --bin bento_cli
```
