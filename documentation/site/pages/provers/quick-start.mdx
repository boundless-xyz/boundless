...
This video was recorded late June 2025; there may be some small changes to the setup process. For the latest commands, make sure to check the tutorial below.

<YoutubeEmbed videoId="1Z_31HHB3_Y" />
