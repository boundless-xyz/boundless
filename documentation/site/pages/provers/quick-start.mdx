...
Next, you'll need to tune your Broker's settings, please see [Broker Optimization](/provers/broker#broker-optimization). If you'd like to learn more about the technical design of Bento, please see the [Bento Technical Design Reference](http://localhost:5173/bento-technical-design).
