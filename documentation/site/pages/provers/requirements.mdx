...
Boundless' proving stack supports multi GPU proving as a first class citizen; please see multi GPU [configuration](https://docs.beboundless.xyz/provers/performance-optimization#multiple-agents-and-gpus) and [performance optimization](https://docs.beboundless.xyz/provers/performance-optimization) for more details.
