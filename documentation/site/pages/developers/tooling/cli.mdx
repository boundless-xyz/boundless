...
The `proving` subcommand is used to manage the proving process for proof requests on the Boundless Market. It allows you to execute guest code locally and generate proofs.
