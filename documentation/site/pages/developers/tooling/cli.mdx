...
Locally executes (without proving) the given request's guest code, either from a YAML file or fetching from onchain/offchain. Allows checking correctness prior to submission:
...
# The input data is an encoded guest environment.
