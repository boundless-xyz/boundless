...
use boundless_market::{
  ...
  contracts::{ProofRequest, Requirements, Predicate, Offer},
  input::InputBuilder,
...
async fn proof_submission(rpc_url: Url, market_address: Address, set_verifier_address: Address) -> anyhow::Result<()> {
    let client = ClientBuilder::new()
        .with_rpc_url(rpc_url)
        .with_boundless_market_address(market_address)
        .with_set_verifier_address(set_verifier_address)
