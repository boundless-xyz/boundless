...
The Steel Events feature enables the developer to query events directly within their guest program.

To enable the Steel Events feature, the feature flag “event” needs to be added to the `risc0-steel` dependency:
