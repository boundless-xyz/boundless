...
The recommended place to start is [Steel examples](https://github.com/risc0/risc0-ethereum/tree/main/examples), specifically the [ERC20 Counter](https://github.com/risc0/risc0-ethereum/tree/main/examples/erc20-counter) example.
