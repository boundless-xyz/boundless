...
# use boundless_market::input::Input;
# use std::ops::Div;
#
# // Function that takes the required parameters so we don't need to construct them
# fn example(
#     boundless_client: &Client<impl alloy::providers::Provider, impl alloy::signers::Signer>,
...
# let smart_contract_requestor_address = [0u8; 20].into();
