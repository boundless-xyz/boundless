...
During this process, the documentation refers to IPFS as the input storage provider (see [Upload your inputs](/developers/tutorials/request#3-upload-the-input-of-your-program-to-ipfs), [BuiltInStorageProvider](https://docs.rs/boundless-market/latest/boundless_market/storage/enum.BuiltinStorageProvider.html) and [storage_provider_from_env](https://docs.rs/boundless-market/latest/boundless_market/storage/fn.storage_provider_from_env.html)).
