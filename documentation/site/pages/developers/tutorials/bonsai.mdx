...
- Strong cryptoeconomic guarantees (through prover slashing and automatic retry logic) on the delivery time of proofs, which is highly configurable via the request [Offer](/developers/tutorials/configure) parameters.
