...
The [Offer](/developers/tutorials/configure) specifies how much the requestor will pay for a proof, by setting the auction price, timing, stake requirements, and expiration.
