...
|----------------|---------|--------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------|
| Ramp Up Start  | seconds  | TODO | Use 10 blocks if you want to more aggressively prioritize latency with the potential of adding more costs in the short to medium term |
| Ramp Up Period | blocks  | TODO| Example : With 1¢ increments per block, divide  Max Price  by $0.01 to determine period length.|
