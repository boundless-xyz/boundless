...
|----------------|---------|--------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------|
| Ramp Up Start  | seconds  | 10 | This parameter is important, as the lock timeout and timeout are specified in seconds *after* the ramp up start timestamp. Therefore, setting it equal to 10 specifies 10 seconds in the future after order creation. If it is set to 0, the current UNIX timestamp, at order creation, will be used. |
