...
Running a *competitive* prover requires expensive hardware and extensive expertise. We predict that multiple top of the line GPUs (e.g. 4090s) will be necessary to run a profitable prover. Please see the [Requirements](/prove/requirements) section for more details.
:::
