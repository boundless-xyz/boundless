...
[Bento](/prove/bento) is a semi multi-tenant proving cluster for the [RISC0 zkVM](https://dev.risczero.com/api/zkvm/). Concretely, Bento is a Docker compose stack which contains all the services needed to run a Bento cluster.
