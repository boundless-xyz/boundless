...
1. Bento - Bento is the local proving infrastructure. Bento will take requests, prove them and return the result 
2. Broker - Broker interacts with the boundless network. Broker can submit or request proves from the boundless network.
