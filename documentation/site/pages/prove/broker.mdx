...
:::warning
TODO: Discuss HP here
:::

### Deposit Stake to the Market

:::warning
TODO: Link to boundless-cli install instructions
:::
...
# Example: 'deposit-stake 10'
boundless-cli deposit-stake <ETH_TO_DEPOSIT>
```
...
....
BOUNDLESS_MARKET_ADDR=0x69c7943DA0D7e45D44Bd0cE7a2412DCdAe423788 # This is the address of the market contract on the target chain.
....
