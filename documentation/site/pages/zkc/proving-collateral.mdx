...
*$ZKC* is deployed on Ethereum mainnet. To use *$ZKC* in the Boundless market as [Proving Collateral](/provers/quick-start#deposit-collateral) on Base mainnet, *$ZKC* must be bridged from mainnet to Base mainnet.

![Multi Chain Proving](/multi_chain_proving.png)

## Briding $ZKC to use as Proving Collateral
