...
```bash
2025-09-14T20:12:47.730771Z  INFO boundless_cli::commands::zkc::get_current_epoch: Current epoch: 9
```
...
```bash                                                     boundless_cli::commands::zkc::get_epoch_end_time: Epoch 9 end time UTC: 2025-09-15 23:55:35
```
