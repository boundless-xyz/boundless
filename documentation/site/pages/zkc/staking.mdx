...
- Provers must stake $ZKC to be eligible for these rewards. Each prover has a reward cap based on their staked $ZKC. This reward cap is set to `staked amount / 15`. 
    - Therefore if a prover has staked 150 $ZKC, they are eligible to receive a maximum of 10 $ZKC every epoch. If a prover would have received more $ZKC due to their cycle contribution but under-staked $ZKC, the delta remains unclaimed which can be distributed at a later date.
