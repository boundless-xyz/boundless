...
For mining rewards, delegation is a recommended practice as it allows for separation between the wallet that stakes *$ZKC* and the wallet specified in Bento in work proofs as the `REWARDS_ADDRESS`. For more information, please see [PoVW Quick Start](/zkc/mining/quick-start).
