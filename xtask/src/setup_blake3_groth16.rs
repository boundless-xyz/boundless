...
const RISC0_TO_BITVM2_URL: &str = "https://github.com/chainwayxyz/risc0-to-bitvm2.git";
...
impl SetupBlake3Groth16 {
    pub fn run(&self) {
        ...
        #[cfg(feature = "cuda")]
        {
            ...
            let mut setup_params = risc0_groth16_sys::SetupParams::new(&setup_dir).unwrap();
            setup_params.srs_path = srs_path.try_into().unwrap();
